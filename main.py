...
csi_300_norm = calculate.normalize(csi_300_data)
csi_a500_norm = calculate.normalize(csi_a500_data)
star_norm = calculate.normalize(star_data)
csi_dividend_norm = calculate.normalize(csi_dividend_data)
